...
class Ajax_pagination{
	...
	var $cur_tag_open		= '<li class="act"><a>';
	...
	function create_links(){
		...
		if (($this->cur_page + $this->num_links) < $num_pages){
			...
			$output .= '<li>'.$this->last_tag_open . $this->getAJAXlink( $i, $this->last_link ) . $this->last_tag_close.'</li>';
		}
