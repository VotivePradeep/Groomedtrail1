...
class Common_socialviralposts extends CI_Model {
	...
	public function countwhereuser_detials($table,$where)
	{
	   $this->db->select('*');
	   $q = $this->db->get_where($table,$where);
	  return $q->row();
	...
	public function getAll($table,$order=null,$orderby=null,$where=array(),$start=0,$limit='')
	{
...
public function getAll1($table,$cid)
	...
	function jointhreetableforum($table, $field_first, $table1, $field_second,$table2,$field_third,$value,$where='',$order_id, $order_arg,$field,$start=0,$limit='') {
