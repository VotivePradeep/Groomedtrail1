                                  ...
                                  <div class="modal-body">
                                    ...
                                    <p class="vac_msg">
                                      <select name="statusChange" id="statusChange_<?php if(isset($classified->classified_id)){echo $classified->classified_id; }?>" class="change-status-ad">
                                        ...
                                        <option value="Approved" <?php if($classified->classified_status == 1){echo 'selected'; } ?>>Approved</option>
                                        <option value="Rejected" <?php if($classified->classified_status == 2){echo 'selected'; } ?>>Rejected</option>
                                      </select>
                                    </p>
                                    <p class="vac_msg">
                                      <span>Message</span>
                      ...
                      <?php
                       ...
                       <?php if($flag1 == 1 || $flag2 == 1 || $flag3 == 1){ ?>
                        <td>
                           ...
                           <?php }  ?>
                            <?php if($flag1 == 1){ ?>
                             <li><a class="btn btn-default btn-sm deletclassified btn-delete" onClick="deletefuncClas(<?php if(isset($classified->classified_id)){echo $classified->classified_id;} ?>, 'tbl_classified_list', 'Do you want to remove this classified?')" id="<?php if(isset($classified->classified_id)){echo $classified->classified_id;}?>" classimg="<?php if(isset($classified->classified_image)){echo $classified->classified_image;}?>" >Delete</a></li>
                           <?php }  ?>
                        ...
                        <?php }elseif ($u_id==1) { ?>
                         <td>
                          <ul class="edv-option">
                           ...
                           <li><a class="btn btn-default btn-sm deletclassified btn-delete" id="<?php if(isset($classified->classified_id)){echo $classified->classified_id;}?>" onClick="deletefuncClas(<?php if(isset($classified->classified_id)){echo $classified->classified_id;} ?>, 'tbl_classified_list', 'Do you want to remove this classified?')" classimg="<?php if(isset($classified->classified_image)){echo $classified->classified_image;}?>" >Delete</a></li>
                         </ul>
...
/////////////////////////delete poi////////////////
/*
$('.deletclassified').click(function(){
 var del_id= $(this).attr('id');
 var classimg= $(this).attr('classimg');
 var tablename= 'tbl_classified_list';
           
if (confirm('Do you want to remove this Classification?'))
{

$.ajax({
        type:'POST',
        url:'<?php echo base_url();?>administrator/admin/deletefun',
        data:{ del_id:del_id, tablename:tablename,classimg:classimg },
        success: function(data){
          if(data == 1){
             location.reload();
          }
...
/////////////////////////delete poi////////////////
$(document).on('click','.rent_sub', function(){
