        ...
        <div class="col-md-12">
            <div class="panel panel-default add-kml-sec">
                ...
                <div id="responseMsg"></div>
                 <form  method="post" id="trailreportedit" action="<?php echo base_url().'administrator/trailreportedit/'; ?><?php if(isset($trailEdit[0]->region_name)){echo str_replace(' ', '-', $trailEdit[0]->region_name); } ?>/<?php if(isset($trailEdit[0]->county_name)){echo str_replace(' ', '-', $trailEdit[0]->county_name); } ?>"  enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label cms-label">Zip Code</label>
                        <div class="col-sm-8">
                            <input type="text" name="zipcode" id="zipcode" value="<?php if(isset($trailEdit[0]->zipcode)){echo $trailEdit[0]->zipcode; } ?>">
                            <label id="zipcode-error" class="error" for="zipcode"><?php echo form_error('zipcode');?></label>
                        </div>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <textarea type="text" name="trail_conditions" id="trail_conditions" rows="4" cols="50"><?php if(isset($trailEdit[0]->trail_conditions)){ echo $trailEdit[0]->trail_conditions; } ?></textarea>
