...
<div class="panel panel-default POI-table">
  <div class="panel-body">
    ...
    <button  class="ViewPendingUpdates">View Pending Submissions</button>
    ...
    <div id="AllTrailData">
      <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="toggleColumn-datatable" >
        <thead>
          <tr>
            <th><input type="checkbox" class="mail-checkbox mail-group-checkbox" value="1" id="select_all1"/>
      </th>
            <th>State Name</th>
            <th>County</th>
            <th>Zip Code</th>
...
<div id="PendingUpdates" style="display: none;">
  ...
  <tbody >
    ...
    foreach ($ViewPendingUpdates as $trail_conditions) {
      ...
      $query = $this->db->query ('SELECT * FROM county_trail_report  WHERE region_name = "'.$trail_conditions->state_name.'" and  county_name = "'.$trail_conditions->CountyID.'" group by `county_trail_report`.`region_name`,`county_trail_report`.`county_name`');
      $result= $query->result();
    //  print_r($result);
    ...
    ?>
    <tr>
      <td><input type="checkbox" name="inbox_id[]" class="mail-checkbox mycheckbox" value="<?php if(isset($trail_conditions->county_name) && !empty($trail_conditions->CountyID)) {echo $trail_conditions->CountyID;} ?>" ></td>
