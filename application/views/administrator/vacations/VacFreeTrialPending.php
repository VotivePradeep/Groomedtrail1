...
<div class="page-header"><h3>Free Trial Rental Listings <span class="totalrecordvac">Total Records(<?php if(isset($businessList)){ echo count($businessList);  }else{echo 0;} ?>)</span></h3></div>
                        ...
                        <td>
                          ...
                          if ($flag == 1) { 
                            ...
                            if($business->vac_status == 0){ ?>
                               <a href="javascript:void(0);"  class="btn btn-default btn-sm" data-toggle="modal" data-target="#myModal<?php if(isset($business->vac_id)){echo $business->vac_id;}?>">Publish</a>
