...
<style type="text/css">
 ...
 .vac_city {
  ...
  .preview-page ul li span.preview-note {
    float: left;
    width:  100%;
  }
</style>
          ...
          <div class="col-md-9 col-sm-8 no-paddng">
            ...
            <div class="business-detail-sec">
              ...
              <div class="business-frm">
                ...
                <h3>Preview Rental Details 
                      <button onClick="window.location.href='<?php echo base_url().'user/rentals/edit/'.$businessDetail->vac_id; ?>'" style="margin-left: 10px;">Edit Your Listing </button>
                        ...
                        <button onClick="window.location.href='<?php echo base_url(); ?>paypal/advert_buy/<?php if(isset($businessDetail->vac_id)) {echo $businessDetail->vac_id; }?>'">Continue to Payment</button>
                        <span class="alert paymentsts" >You will be redirected to Paypal to complete the payment.</span>
