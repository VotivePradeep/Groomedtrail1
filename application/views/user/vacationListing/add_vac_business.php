            ...
            <?php  }
              ...
              <div class="col-md-6 form-group">
               ...
               <div class="col-md-3 form-group">
                  ...
                  <input type="text" name="vac_city" id="vac_city" class="form-control" placeholder="Enter city"  value="<?php if(isset($businessDetail->vac_city)) {echo $businessDetail->vac_city; }else{echo set_value('vac_city'); }?>" />
                    <input type="hidden" name="vac_state" id="vac_state" class="form-control" value="<?php if(isset($businessDetail->state_name)){ echo $businessDetail->state_name; }else{echo 'Michigan';} ?>"  />
             ...
             <div class="row">
              <div class="col-md-12 form-group">
               ...
               <div id="result1">
                   <?php foreach($busPhotos as $busPhotos) {?>
                    <div class="previewImage" id="cross<?php echo $busPhotos->vac_img_id;?>">
                    <a class="removeimg" id="<?php echo $busPhotos->vac_img_id;?>" name="<?php echo $busPhotos->vac_imag;?>">
                        <i class="fa fa-trash-o" aria-hidden="true"></i>
                    </a>
                     <img name='img["<?php echo $clsImg->cls_img_id;?>"]' class='thumbnail' src='<?php if(isset($busPhotos->vac_imag) && !empty($busPhotos->vac_imag)){ echo base_url().$busPhotos->vac_imag;}?>' style='width:100px;height:100px;'/>
                ...
                <div class="row1">
                  <div class="col-md-12 form-group">
                    <div class="listform-group rental-features-list">
                      <label for="vac_amenities">Amenities</label>
                         <?php if(isset($propertyList)){
                          foreach ($propertyList as $FeaturesType) { 
                            if($FeaturesType->f_cat_name == 'Features'){ ?>
                           <span>
                            <!-- <input type="checkbox" name="vac_amenities[]" id="vac_amenities" value="<?php //if(isset($FeaturesType->f_id)){ echo $FeaturesType->f_id; }?>"   <?php //echo set_checkbox('vac_amenities[]', $FeaturesType->f_id); ?>
                              <?php 
                              ...
                              foreach ($valueA as $valueA) { if($valueA ==  $FeaturesType->f_id){  echo $checked='checked';  }   else  { echo $checked = '';   } } }?>  > -->
                               <div class="chk-head">
                                  <div class="main-chk">
                                     <input type="checkbox" name="vac_amenities[]" id="vac_amenities<?php if(isset($FeaturesType->f_id)){ echo $FeaturesType->f_id; }?>" value="<?php if(isset($FeaturesType->f_id)){ echo $FeaturesType->f_id; }?>" <?php echo set_checkbox('vac_amenities[]', $FeaturesType->f_id); ?> <?php 
                                                 if(isset($businessDetail->adv_filter_fields)){
                                                $valueA = explode(",", $businessDetail->adv_filter_fields);
                                                foreach ($valueA as $valueA) { if($valueA ==  $FeaturesType->f_id){  echo $checked='checked';  }   else  { echo $checked = '';   } } }?> >

                                     <label for="vac_amenities<?php if(isset($FeaturesType->f_id)){ echo $FeaturesType->f_id; }?>"></label>
                                     <span class="rental-features-name"><?php if(isset($FeaturesType->f_subcat_name)){ echo $FeaturesType->f_subcat_name; }?> </span>
                                  </div>
                              </div> 
                             </span>
                         <?php } } } ?>  
...
messages: {
 ...
 // vac_state:{ required: "Please enter state" },
