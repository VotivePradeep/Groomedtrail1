									    ...
									    <div class="fo_text">
										   	<div class="reply_section">
												<ul>
													...
													<li> <span><i class="fa fa-heart" aria-hidden="true"></i></span><span class="topicTotallike">  <?php echo $totallike;?></span></li>
							...
							<div class="row">
                             ...
                             // print_r($path_parts);
								...
								echo "<a target='_blank' href='".base_url().'assets/editor_images/'.$basename."'><img class='file_icon' src='".base_url().'assets/images/pdf.png'."'></a>"; 
										...
										/* echo "<iframe src='http://docs.google.com/gview?url=".base_url().'assets/editor_images/'.$basename."&embedded=true'></iframe>";	*/									 
									 } 
									 } 
								?>								
								</span>
								...
								<p><div class="comment_text"><?php echo $item->forum_comment_description; ?></div></p></div>
					                ...
					                <div class="reply_section">
					                    <ul>
										    ...
										    <li><h5><a href="javascript:" id="<?php echo $item->forum_comment_id; ?>" class="commentLike like<?php echo $item->comment_like_me; ?>"><i class="fa fa-heart" aria-hidden="true"></i> like(<span class="topicGridlike"><?php echo $item->comment_likes; ?></span>)</a></h5></li>
								...
								<input type="hidden" name="forum_comment_id" value="<?php echo $item->forum_comment_id; ?>">
								  ...
								  <div class="form-group">
									<label class="col-sm-3 control-label image_label">Upload file <sup>*</sup>image,video(mp4),pdf,docx</label>
									<div class="col-sm-9">
                             ...
                             // print_r($path_parts);
								...
								<?php } ?>		
											...
											?></h5></li>
					                    	<li><h5><a href="javascript:" id="<?php echo $itemch->forum_comment_id; ?>" class="commentLike like<?php echo $itemch->comment_like_me;?>"><i class="fa fa-heart" aria-hidden="true"></i> like(<span class="topicGridlike"><?php echo $itemch->comment_likes; ?></span>)</a></h5></li>
											<li class="pull-right">
                                            <?php if($flag == 1 || $u_id == 1) {?>
											<button class="replay-btn" id="post-1"><i class="fa fa-reply"></i> Reply</button>
											<?php } ?>
					...
					<div class="forum-main-reply-sec">
						<div class="row">
							<div class="col-md-12">
						        ...
						        <!-- <textarea  name="forum_comment_description1" id="summernote1" class="control-label" placeholder="Enter Qualification detail here"></textarea>
								 -->
	                        ...
	                        <div class="col-sm-8">
                            <!--<span class="btn btn-default btn-file">Upload File
	                         <input type="file" name="upload" value="" placeholder="Required Field" class="form-control" >
                            </span>-->
                            <div class="uplod-file-btn" style="position:relative;">
								<a class='btn btn-primary' href='javascript:;'>
	...
	var forum_cat_id=$("#forum_cat_id").val();
		...
		//	alert(data);
		  ...
		  $(".topicTotallike").text(data.total);
			$('#'+forum_comment_id).html("<i class='fa fa-heart' aria-hidden='true'></i> like(<span class='topicGridlike'>"+data.commlike+"</span>)").addClass('like1');
...
$(document).ready(function(){
    ...
    $('.right_smiley').toggleClass('contacts_full');  
			...
			<script>
				...
				var CONTACTS = [
				{ avatar: 'regular_smile' },{  avatar: 'angry_smile' },{avatar: 'angel_smile' },{  avatar: 'sad_smile' },{  avatar: 'grin' },{  avatar: 'shades_smile' },{  avatar: 'teeth_smile' },{  avatar: 'tongue_smile' },{  avatar: 'whatchutalkingabout_smile' },{  avatar: 'wink_smile' },{  avatar: 'angel_smile' },
				{  avatar: 'hfin' },{  avatar: 'broken_heart' },{  avatar: 'confused_smile' },{  avatar: 'cry_smile' },{  avatar: 'devil_smile' },{  avatar: 'embarrassed_smile' },{  avatar: 'envelope' },{  avatar: 'thumbs_down' },{  avatar: 'thumbs_up' },{  avatar: 'heart' },{  avatar: 'kiss' },{  avatar: 'lightbulb' },{  avatar: 'omg_smile' },{  avatar: 'dartagnan' },{  avatar: 'pfog' },{  avatar: 'alice' },{ avatar: 'lrrh' },{ avatar: 'winetou' },{ avatar: 'edantes' },{  avatar: 'rcrusoe' }
				];
