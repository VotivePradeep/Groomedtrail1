          ...
          <div class="description-sec">
            ...
            <div class="descip-txt">
              <div  class="btns-msg "> 
                <div id="reviewDiv">   
                 <?php 
                 // $query = $this->db->query("select * from tbl_review where user_ID =".$user_id." and bus_ID = ".$businessDetail[0]->vac_id."");
                // $result = $query->result();
                 // if(isset($result)){
                //  foreach($result as $r){
                        ...
                        <div id="dumpallmsg" class="message_body_main">
                          <div class="booking_detail_main_bottom_one_zeerba">
                            ...
                            <div class="booking_detail_main_bottom_one_zeerba_r">
                              ...
                              <span class="book_sp"><?php if(isset($totalReview->comment)){echo $totalReview->comment; }?></span>
                            </div> 
...
<script>
  ...
  /******************* review form. *************************/
   ...
   if(rating!==undefined && comment !='' ){
    ...
    alert('please click the review star');
   }
  return false;
