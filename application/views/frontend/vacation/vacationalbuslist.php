...
<script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyCEDVd3ns05bhTmlTSlS_zopAJxkbkp5hw"></script>
<body>
...
<div id="sticky-anchor"></div>
    <div class="map-main sticky" >
        <div class="google-ad" style="float: right; !important">
            <?php $googleAds = $this->model->get_row('tbl_google_ads',array('pagename'=>'Lodging'));
            ?>
            <style>
