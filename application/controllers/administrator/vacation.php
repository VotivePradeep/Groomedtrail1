...
submitHandler: function(form) {
 ...
 $("#progress_bg").show();
  ...
  if(vac_id != '' ){
     action_url = "<?php echo base_url(); ?>administrator/Vacations/rental_edit_submit";
  }else{
     action_url = "<?php echo base_url(); ?>administrator/Vacations/rental_submit";
  }
  $.ajax({
    type:'POST',
    url: action_url,
   ...
   /* beforeSend: function() {
    ...
    success:function(data){
      ...
      window.location.href = data.page_url+"administrator/rentalslist";
      return false;
    } 
  }); 
